...
ALTER TABLE projects
    ADD FOREIGN KEY (client_id) REFERENCES companies (id);
ALTER TABLE persons
    ADD FOREIGN KEY (company_id) REFERENCES companies (id);
ALTER TABLE teams_persons
...
ALTER TABLE task_statuses
    ADD FOREIGN KEY (status_category_id) REFERENCES status_categories (id);
ALTER TABLE tasks
    ADD FOREIGN KEY (task_status_id) REFERENCES task_statuses (id);
ALTER TABLE project_statuses
    ADD FOREIGN KEY (status_category_id) REFERENCES status_categories (id);
ALTER TABLE projects
    ADD FOREIGN KEY (project_status_id) REFERENCES project_statuses (id);
ALTER TABLE projects_persons
    ADD FOREIGN KEY (person_id) REFERENCES persons (id);
ALTER TABLE projects_persons
    ADD FOREIGN KEY (project_id) REFERENCES projects (id);